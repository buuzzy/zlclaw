...
// HTTP example:
{
  ...
  wechatDescription: 'Scan QR code to connect ClawBot via WeChat.',
  wechatRecommended: 'Recommended',
  wechatConfigure: 'Configure',
  wechatDisconnect: 'Disconnect',
  wechatScanning: 'Scan this QR code with WeChat',
  wechatExpireIn: 'Expires in {seconds}s',
  wechatConnected: 'Connected',
  wechatDisconnected: 'Not connected',
  wechatConnecting: 'Connecting...',
  wechatRefreshQr: 'Refresh QR Code',
  wechatNotInstalled: 'WeClaw not installed',
  wechatNotInstalledHint: 'Please install WeClaw WeChat gateway first',
  wechatInstallGuide: 'Install Guide',
  wechatStartFailed: 'Start failed',
  feishuTitle: 'Feishu (Lark)',
  feishuDescription: 'Connect Bot via Feishu Open Platform.',
  feishuEnabled: 'Enable Feishu',
  feishuAppId: 'App ID',
  ...
  feishuConfigSaved: 'Config saved',
  feishuConnected: 'Connected',
  feishuDisconnected: 'Disconnected',
  feishuConnecting: 'Connecting...',
  feishuError: 'Connection failed',
  feishuNotConfigured: 'Not configured',
  feishuConfigure: 'Configure',
  feishuReconfigure: 'Reconfigure',
  feishuConnect: 'Connect',
  feishuDisconnect: 'Disconnect',
  feishuTestConnection: 'Test Connection',
  feishuTesting: 'Testing...',
  feishuTestSuccess: 'Credentials verified',
  feishuTestSuccessWithName: 'Verified — Bot: {name}',
  feishuTestFailed: 'Credentials verification failed',
  feishuSaveAndConnect: 'Save & Connect',
  feishuSaving: 'Saving...',
  ...
  cronAdd: 'New Job',
  cronEmpty: 'No scheduled jobs yet',
  cronAddFirst: 'Click "New Job" to get started',
  cronRefresh: 'Refresh',
  cronRetry: 'Retry',
  cronDeleteConfirm: 'Delete scheduled job "{name}"?',
  cronCreateTitle: 'New Scheduled Job',
  cronName: 'Job Name',
  ...
  cronCancel: 'Cancel',
  cronCreate: 'Create',
  cronCreating: 'Creating…',
  cronCreateRequired: 'Name and prompt are required',
  cronCreateFailed: 'Failed to create job',
};
