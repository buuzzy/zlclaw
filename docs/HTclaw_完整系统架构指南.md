...
1. **HTclaw_后端数据结构分析.md** - 后端 15+ Skills、返回字段、工具调用策略
2. **HTclaw_前端组件架构分析.md** - 前端 13 个组件、类型系统、渲染机制、开发指南
3. **HTclaw_完整系统架构指南.md** - 本文档，系统全景、数据流、设计决策
...
| 文档 | 用途 |
|------|------|
| HTclaw_后端数据结构分析.md | Skill 返回字段、API 规范 |
| HTclaw_前端组件架构分析.md | 组件实现、样式、开发指南 |
