---
name: 基本资料查询
description: 基本资料数据查询skill。查询全品类标的（股票、指数、基金、期货、期权、转债、债券、理财、保险等）的基础信息、发行主体、机构资料、费率、上市地点、上市日期等静态信息，支持自然语言问句输入，返回相关基本资料数据结果。当用户询问股票基本信息、基金资料、期货合约信息、债券资料、费率信息、上市日期等基本资料查询问题时，必须使用此技能。
promptDescription: 基本资料查询：公司信息、上市日期、行业、股东结构等静态数据
whenToUse: 基本资料,公司信息,上市时间,行业,股东,注册资本,总股本,流通股,法人,基金费率,发行信息
---
...
```bash
# 查询股票上市日期
python3 scripts/cli.py --query "贵州茅台上市日期？"
